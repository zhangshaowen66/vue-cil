<template>
  <div class="di main-wrap" v-loading="audio.waiting">
    ...
    <div>
      ...
      <el-slider v-show="!controlList.noProcess" v-model="sliderTime" :format-tooltip="formatProcessToolTip" @change="changeCurrentTime" @input="InputCurrentTime" class="slider"></el-slider>
  ...
  export default {
    ...
    methods: {
      ...
      changeCurrentTime(index) {
        console.log( parseInt(index / 100 * this.audio.maxTime),' 播放位置')
        this.$refs.audio.currentTime = parseInt(index / 100 * this.audio.maxTime)
      },
      InputCurrentTime(index) {
        // parseInt(this.audio.currentTime / this.audio.maxTime * 100)
       // this.$refs.audio.currentTime = parseInt(index / 100 * this.audio.maxTime)
        if (index !== parseInt(this.audio.currentTime / this.audio.maxTime * 100)) {
          this.$refs.audio.currentTime = parseInt(index / 100 * this.audio.maxTime)
        }
      },
      startPlayOrPause() {
